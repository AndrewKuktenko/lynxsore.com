...
class Product
{
    ...
    public static function getLatestProducts($page = 1, $count = self::SHOW_BY_DEFAULT) {
        ...
        $result = $db->query('SELECT id, price, is_new, name FROM product '
            .'WHERE status = "1" '
            .'ORDER BY id DESC '
            .'LIMIT '.$count
            .' OFFSET '.$offset
    ...
    public static function getProductListByCategory($categoryId = false, $page = 1, $count = self::SHOW_BY_DEFAULT)
    {
        if ($categoryId)
        {
            ...
            $result = $db->query('SELECT id, name, price, is_new FROM product WHERE status = "1" AND category_id = '.$categoryId.' ORDER BY id DESC LIMIT '.$count .' OFFSET '.$offset);
    ...
    public static function getRecommendedProducts()
    {
        ...
        $sql = "SELECT * FROM product WHERE is_recommended = '1' AND status = '1'";
